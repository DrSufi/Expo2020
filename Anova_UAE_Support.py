...
file_path = 'C:\\Users\\USER\\Documents\\Research\\Development\\UAEsupport.csv'  # Replace with the path to your CSV file
...
variables = [
    'NumberofTweets', 'NumberofUniqueUsers', 'RetweetCount',
    'FollowerCount', 'FriendCount', 'NumberofUniqueLocations',
    'NumberofUniqueLanguages', 'ConfidenceofPositiveSentiment',
    'ConfidenceofNeutralSentiment', 'ConfidenceofNegativeSentiment'
]
